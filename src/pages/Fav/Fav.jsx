        ...
        <>
            {
                ...
                ?(<Container fluid className="container" xs={12} md={12} xl={12}>
                    {reduxFavData.items.map(
                    deal => {
                        return(
                            <>
                                <div className="carrito" key={reduxFavData.gameID}>
                                    <p>{deal}</p>
                                    <Button className="vaciarUno" onClick={() => dispatch(remove([this]))}>Eliminar</Button>
                                </div>
                            </>
                ...
                <Button className="vaciar" onClick={() => dispatch(remove([]))}>Eliminar todos los favoritos</Button>
                </Container>
