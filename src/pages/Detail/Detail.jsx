        ...
        <Container fluid className="contenedorDetail" xs={12} md={12} lg={12}>
                <div className="DetailCard" xs={12} md={12} lg={6}>
                    ...
                    <div className="DetailCard-footer">
                        ...
                        <a target="_blank" href={linlReviews+reduxDealData.metacriticLink}><img className="metacritic" src={metacritic}></img></a>
                    </div>
                </div>
                ...
                <div className="DetailCardPrecios" xs={12} md={12} lg={6}>
                    ...
                    ?(
                        <Row>
                            <Button className="favButton" onClick={() => dispatch(add(reduxDealData.title))}>Favorito</Button>   
                        </Row>
                    ) : (
                        <Row></Row>    
                    )
